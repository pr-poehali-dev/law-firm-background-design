...
export default function Index() {
  ...
  const services = [
    { icon: 'Scale', title: 'Корпоративное право', description: 'Юридическое сопровождение бизнеса, регистрация компаний, договорное право' },
    { icon: 'FileText', title: 'Гражданские споры', description: 'Защита интересов в судах всех инстанций, арбитражные споры' },
    { icon: 'Home', title: 'Недвижимость', description: 'Сделки с недвижимостью, оформление прав собственности' },
    { icon: 'Users', title: 'Семейное право', description: 'Разводы, раздел имущества, алименты, опека' }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section id="services" className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">Мы собрали здесь наши ключевые услуги —
