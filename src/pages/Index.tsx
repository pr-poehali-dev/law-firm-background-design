...
export default function Index() {
  ...
  const services = [
    { icon: 'Scale', title: 'Консультация', description: 'Юридическое сопровождение бизнеса, регистрация компаний, договорное право' },
    { icon: 'FileText', title: 'Претензии', description: 'Защита интересов в судах всех инстанций, арбитражные споры' },
    { icon: 'Home', title: 'Жалобы, обращения, заявления', description: 'Сделки с недвижимостью, оформление прав собственности' },
